...
class JWTInfos(JParent):
    def __init__(self, guid: str, role: str, exp: int):
        self.__InitJParent(guid, role, exp)

    # Values Assignement
    def __InitJParent(self, guid: str, role: str, exp: int):
        self.guid = guid
        self.role = role
        self.exp = exp
    ...
    def __EvaErrorsJParent(self):
        ...
        if (type(self.role) is not str): return "role invalid variable type"
