...
class Box(JObject):
    ...
    def __init__(self, boxid: str, activity: bool, severity: BoxSeverity):
        self.__InitOutputJObject(boxid, activity, severity)
    ...
    def __InitOutputJObject(self, boxid: str, activity: bool, severity: BoxSeverity):
        self.boxid = boxid
